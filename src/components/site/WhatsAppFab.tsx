...
export function WhatsAppFab({ phone }: { phone: string }) {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 transition-transform hover:scale-105 z-40 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_10px_40px_-10px_#25D366]"
    >
