...
export function Hero() {
  return (
    <section className="relative flex min-h-[80svh] flex-col items-center justify-center px-5 pb-16 pt-32 text-center">
      ...
      <p className="eyebrow mb-6 text-champagne">Alta peluquería · Bogotá</p>
      <h1 className="font-display text-6xl leading-[0.95] md:text-8xl">Infante Hair Stylist</h1>
      ...
      <p className="mt-12 text-sm text-ivory/50">Calle 86A # 13A-09 · Lun – Sáb · 6 am – 7 pm</p>
    </section>
  );
}
